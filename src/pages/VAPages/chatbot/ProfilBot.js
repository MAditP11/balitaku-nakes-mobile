...
import AksesProfilBot from './profilbot/AksesProfilBot';
import EditDataBot from './profilbot/EditDataBot';
import KeluarHapusBot from './profilbot/KeluarHapusBot';
const { height, width } = Dimensions.get('window');

const lpOps = [
  {
    id: 1,
    name: 'Akses Halaman Profil',
  },
  {
    id: 2,
    name: 'Edit Data Diri',
  ...
  {
    id: 3,
    name: 'Keluar dan Hapus Akun',
  },
];

function ProfilBot({ disabled }) {
  ...
  return (
    <View>
      ...
      {lp2[0] !== undefined && lp[0] === 'akses halaman profil' ? (
        <AksesProfilBot />
      ) : lp2[0] !== undefined && lp[0] === 'edit data diri' ? (
        <EditDataBot />
      ) : lp2[0] !== undefined && lp[0] === 'keluar dan hapus akun' ? (
        <KeluarHapusBot />
      ) : null}
      {lp3[0] !== undefined ? lpOpss() : null}

      {lp[1] !== undefined ? userlp(1) : null}
      {lp2[1] !== undefined && lp[1] === 'akses halaman profil' ? (
        <AksesProfilBot />
      ) : lp2[1] !== undefined && lp[1] === 'edit data diri' ? (
        <EditDataBot />
      ) : lp2[1] !== undefined && lp[1] === 'keluar dan hapus akun' ? (
        <KeluarHapusBot />
      ) : null}
      {lp3[1] !== undefined ? lpOpss() : null}

      {lp[2] !== undefined ? userlp(2) : null}
      {lp2[2] !== undefined && lp[2] === 'akses halaman profil' ? (
        <AksesProfilBot />
      ) : lp2[2] !== undefined && lp[2] === 'edit data diri' ? (
        <EditDataBot />
      ) : lp2[2] !== undefined && lp[2] === 'keluar dan hapus akun' ? (
        <KeluarHapusBot />
      ) : null}
      {lp3[2] !== undefined ? lpOpss() : null}

      {lp[3] !== undefined ? userlp(3) : null}
      {lp2[3] !== undefined && lp[3] === 'akses halaman profil' ? (
        <AksesProfilBot />
      ) : lp2[3] !== undefined && lp[3] === 'edit data diri' ? (
        <EditDataBot />
      ) : lp2[3] !== undefined && lp[3] === 'keluar dan hapus akun' ? (
        <KeluarHapusBot />
      ) : null}
