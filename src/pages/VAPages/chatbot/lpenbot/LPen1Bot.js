    ...
    return (
      <View style={{ marginVertical: 5, paddingVertical: 7, paddingHorizontal: 10, backgroundColor: Colors.PRIMARY_PURPLE, maxWidth: 290, borderRadius: 7 }}>
        <View style={{ marginBottom: 5 }}>
          <Text style={{ color: Colors.DEFAULT_WHITE, fontWeight: 'bold' }}>-- AKSES LAPORAN PENANGANAN --</Text>
        </View>
        ...
        <ImgVA source={require('../../../../images/chatbot/lpen/akses.jpeg')} width={width / 1.3} height={height / 2.55} />
      </View>
    );
  };
